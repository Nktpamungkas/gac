                            ...
                            <?php foreach ($return as $data) : ?>
                                <td>
                                    <li class="dropdown" style="list-style-type:none;">
                                        <a href="#" class="fa fa-bars dropdown-toggle" data-toggle="dropdown"></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="<?= base_url(); ?>auth/viewlimbah/<?= $data['id']; ?>">Tampilkan</a></li>
                                            <!-- <li><a href="<?= base_url(); ?>auth/view_edit/<?= $data['id']; ?>">Edit</a></li> -->
                                            <li><a href="<?= base_url(); ?>auth/hapustiketlimbah/<?= $data['id']; ?>">Hapus</a></li>
                                        </ul>
                                    </li>
                                </td>
                                <td>
                                    <a href="<?= base_url(); ?>auth/viewlimbah/<?= $data['id']; ?>" title="view: <?= $data['nama_pelapor']; ?>">
                                        <?= $data['nama_pelapor']; ?>
                                    </a>
                                </td>
                                <td>
